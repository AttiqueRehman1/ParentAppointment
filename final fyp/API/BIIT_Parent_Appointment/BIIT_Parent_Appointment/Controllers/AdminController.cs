...
namespace BIIT_Parent_Appointment.Controllers
{
    public class AdminController : ApiController
    {
        ...
        [HttpGet]
        public HttpResponseMessage TaskGetLowCGPAStudentsTask()
        {
            try
            {
                //  /api/Admin/GetLowCGPAStudents
        ...
        [HttpGet]
        public HttpResponseMessage TaskGetLowCGPASParentTask()
        {
            try
            {
                //  /api/Admin/GetLowCGPAStudents
        ...
        [HttpGet]
        public HttpResponseMessage TaskLowCGPAAppointmentPrentCall(string date)
        {
            try
            {
                //  /api/Admin/LowCGPAAppointment?date=20/1/2023
        ...
        [HttpGet]
        public HttpResponseMessage TaskLowCGPAAppointmentStudentCall(string date)
        {
            try
            {
                //  /api/Admin/LowCGPAAppointment?date=20/1/2023
